...
st.markdown(
    ...
    f'<strong style="color:#67e8f9;">{s["system_name"]}</strong>&nbsp;&nbsp;&middot;&nbsp;&nbsp;{s["domain"]}&nbsp;&nbsp;&middot;&nbsp;&nbsp;{s["agent_type"]}<br>'
...
st.markdown(
    ...
    f'<div style="color:rgba(255,255,255,0.85);font-size:1rem;">{s["system_name"]} &mdash; Drift Risk: {drift_risk}/100 ({drift_label})</div>'
...
st.markdown(
    ...
    'Treasurety Horizon provides governance forecasting, Trust Horizon analysis, '
    'attractor membership determination, drift dynamics, and mathematical stability intelligence. '
    'While Monitor shows what is happening now, Horizon shows where governance is going.'
    '</div>'
    '</div>'
...
st.markdown(
    ...
    'Treasurety Monitor &mdash; Continuous Drift Detection &amp; Assurance<br>'
    'Partner-ready &middot; White-label capable &middot; Signals feed Treasurety Govern policy engine'
    '</p>',
    unsafe_allow_html=True
)
